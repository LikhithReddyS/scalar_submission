...
# Add the parent directory to Python path so server/ can import root-level modules
...
def run_baseline():
    try:
        ...
        result = subprocess.run([_sys.executable, "inference.py"], capture_output=True, text=True, env=env_vars)
